const MetaData=[
    ...
    [
        "6207 - Dr. D. Y. Patil Vidya Pratishthan Society’s Dr. D. Y. Patil Institute of Technology, Pimpri, Pune",
        16772,
        "88.40/80.10",
        ,
       "IT/AI" 
...
for (let i = 0; i < MetaData.length; i++) {
    ...
    reversedData.forEach((element, index)=>{
        ...
        <td class="Rank">${element[3]}/-</td>
        </tr>
         
        `
    })
    let Meta_Data = document.getElementById('Meta_Data')
    
    Meta_Data.innerHTML=html
